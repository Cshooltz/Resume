...
#### Projects
##### Database Editor
This project is my first practical foray into creating my own GUI application. My goal is to make a simple cross platform database editor that can work with either am embedded database, a database server, or plain text in files. The following are highlights of my current progress (remember, see the GitHub repo for more details):
